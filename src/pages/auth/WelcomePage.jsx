...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-orange-500 text-white flex-col justify-center items-center p-12 relative overflow-hidden">
        ...
        <div className="z-10 text-center max-w-md">
          ...
          <h1 className="text-5xl font-extrabold mb-6">Satu Meja</h1>
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 bg-gray-50 md:bg-white min-h-screen md:min-h-0">
        <div className="w-full max-w-md">
          ...
          <div className="md:hidden flex flex-col items-center mb-10 text-center">
            ...
            <h1 className="text-4xl font-extrabold text-gray-900 mb-2">Satu Meja</h1>
          ...
          <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl md:shadow-none md:border md:border-gray-100 border-none">
            <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Mulai Sekarang</h2>
            
            <div className="space-y-4">
              <button
                onClick={() => navigate('login')}
                className="w-full bg-orange-500 text-white font-bold py-4 px-4 rounded-xl shadow-lg shadow-orange-200 hover:bg-orange-600 transition hover:-translate-y-0.5 active:scale-95 text-lg"
              >
                Masuk ke Akun
              </button>
              ...
              <button
                ...
                className="w-full bg-white border-2 border-orange-500 text-orange-600 font-bold py-4 px-4 rounded-xl hover:bg-orange-50 transition hover:-translate-y-0.5 active:scale-95 text-lg"
              >
                Daftar Akun Baru
              </button>
            </div>
